...
if menu == "Dashboard":
    ...
    fig = make_subplots(
        rows=2, cols=1, shared_xaxes=True, vertical_spacing=0.1, subplot_titles=("Diagnosis Trend Over Time", "Diagnosis Bar Chart"), row_heights=[0.7, 0.3]
    )
...
# ---------------------
    ...
    st.title("📖 About")
    st.markdown("""
    This app is developed by KCCR to assist hospitals in diagnosing chest X-ray scans for pneumonia using AI models. It aims to improve diagnostic accuracy and reduce the burden on healthcare workers.
    """)
